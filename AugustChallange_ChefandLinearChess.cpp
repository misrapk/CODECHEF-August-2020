...
The player who starts at the position 3 can move to square 6. The player at position 2 can capture Chef's pawn in 2 turns, 
whereas the player at position 3 can capture Chef's pawn in 1 turn. Therefore, the answer is 3.
...
#define ll long long
using namespace std;
void countWins(ll a[],ll n, ll k){
	ll min = 1000000000, min2=-1;
